...
import 'package:pam_proyek/ui/screens/cart_page.dart';
...
class _RootPageState extends State<RootPage> {
  List<Accessories> favorites = [];
  List<Accessories> myCart = [];
  ...
  List<Widget> _widgetOptions(){
    return [
      const HomePage(),
      FavoritePage(favoritedAccessoriess: favorites,),
      CartPage(addedToCartAccessoriess: myCart,),
      const ProfilePage(),
    ];
  }
      ...
      bottomNavigationBar: AnimatedBottomNavigationBar(
        ...
        onTap: (index){
          setState(() {
            ...
            final List<Accessories> favoritedaccessoriess = Accessories.getFavoritedAccessoriess();
            final List<Accessories> addedToCartaccessoriess = Accessories.addedToCartAccessoriess();

            favorites = favoritedaccessoriess;
            myCart = addedToCartaccessoriess.toSet().toList();
          });
        }
      ),
    );
