...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    //accessoriess category
    List<String> accessoriesTypes = [
      'Recommended',
      'Necklace',
      'Bags',
      'Watches',
        ...
        children: [
          ...
          Container(
            ...
            child: ListView.builder(
                ...
                itemCount: accessoriesTypes.length,
                        ...
                        children: [
                                ...
                                onPressed: () {
                                  setState(() {
                                    bool isFavorited = toggleIsFavorated(
                                        accessoriesList[index].isFavorated);
                                    accessoriesList[index].isFavorated = isFavorited;
                                  });
                                },
                                icon: Icon(
                                  accessoriesList[index].isFavorated == true
                                      ? Icons.favorite
                          ...
                          Positioned(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  accessoriesList[index].category,
          ...
          Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                      onTap: (){
                        Navigator.push(context, PageTransition(child: DetailPage(accessoriesId: accessoriesList[index].accessoriesId), type: PageTransitionType.bottomToTop));
                      },
                      child: AccessoriesWidget(index: index, accessoriesList: accessoriesList));
                }),
          ),
        ],
      ),
